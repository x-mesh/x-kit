...
function cmdRun(args) {
  ...
  if (opts.json) {
    // Role-based model routing (aligned with x-agent conventions)
...
function cmdDemo(args) {
  ...
  // Output auto-plan JSON for the skill layer to process
  const output = {
    action: 'demo',
    project: projectName,
    demo_dir: demoDir,
 ...
 *   x-build status attendance-dashboard          (positional)
 *   x-build status --project attendance-dashboard (named flag)
 */
